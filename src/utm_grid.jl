...
function draw_utm_grid(m::ModelSpace)
    ...
    draw_utm_grid(m, easting_min, northing_max, easting_max, northing_min; utm_grid_size = m.utm_grid_size, utm_grid_thickness = m.utm_grid_thickness)
end
function draw_utm_grid(m::ModelSpace, easting_min, northing_max, easting_max, northing_min; utm_grid_size = 1000, utm_grid_thickness = 0.5)
...
function draw_model_grid(x0, y0, x1, y1, grid_size, grid_thickness)
    @assert x0 < x1
    @assert y0 > y1
